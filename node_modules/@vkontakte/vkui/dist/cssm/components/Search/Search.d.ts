 ...
 */
export declare const Search: ({ id: idProp, before, className, defaultValue, placeholder, after, getRef, icon, onIconClick, style, autoComplete, onChange: onChangeProp, value: valueProp, iconLabel, clearLabel, noPadding, getRootRef, findButtonText, onFindButtonClick, ...inputProps }: SearchProps) => React.JSX.Element;
