 ...
 */
export declare const CustomSelectOption: ({ children, hierarchy, hovered, selected, before, after, description, disabled, style: styleProp, className, onClick, ...restProps }: CustomSelectOptionProps) => React.JSX.Element;
