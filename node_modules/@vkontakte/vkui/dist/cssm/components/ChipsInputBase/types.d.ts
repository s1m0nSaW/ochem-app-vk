...
import type { HasAlign, HasComponent, HasDataAttribute, HasRef, HTMLAttributesWithRootRef } from '../../types';
...
export type RenderChip<O extends ChipOption = ChipOption> = (props: RenderChipProps, option: O) => React.ReactNode;
...
export type GetNewOptionData<O extends ChipOption = ChipOption> = (value: ChipOptionValue, label: ChipOptionLabel) => O;
 ...
 * @private
 */
type UseChipsInputBaseOnlyNeededProps<O extends ChipOption = ChipOption> = Omit<UseChipsInputBaseProps<O>, 'onChange' | 'defaultValue' | 'defaultInputValue'>;
/**
 * @public
 */
export interface ChipsInputBaseProps<O extends ChipOption = ChipOption> extends UseChipsInputBaseOnlyNeededProps<O>, Omit<React.InputHTMLAttributes<HTMLInputElement>, keyof UseChipsInputBaseProps<O> | 'defaultChecked'>, HasRef<HTMLInputElement>, HasAlign {
