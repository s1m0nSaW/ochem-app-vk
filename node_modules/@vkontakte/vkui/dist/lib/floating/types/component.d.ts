 ...
 */
export type FloatingContentRenderProp = (props: Pick<UseFloatingWithInteractionsReturn, 'onClose'>) => React.ReactNode;
/**
 * Общий API для всплывающих элементов.
 *
 * @private
 */
export interface FloatingComponentProps extends UseFloatingMiddlewaresBootstrapOptions, Omit<UseFloatingWithInteractionsProps, 'placement' | 'middlewares'> {
    /**
